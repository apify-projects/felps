...
export declare type JSONSchemaMethods = {
    resolveList?: (ref: ModelReference, methods: {
        getEntities: (modelName: string, ref?: ModelReference) => TrailDataModelItem[];
    }) => TrailDataModelItem[];
...
export declare type StepCollectionInstance<M extends Record<string, ModelDefinition>, F extends Record<string, FlowDefinition<keyof S>>, S, I extends InputDefinition> = {
...
export declare type StepCollectionOptions<T> = {
    STEPS?: T;
};
...
export declare type StepDefinition<Methods = unknown> = Partial<Pick<StepInstance<Methods & GeneralStepApi>, 'crawlerOptions'>>;
...
export declare type GeneralStepApi<I extends InputDefinition = InputDefinition> = StepApiMetaAPI<I> & StepApiHelpersAPI;
export declare type StepApiOptions = {
...
export declare type StepApiFlowsAPI<F extends Record<string, FlowDefinition<keyof S>>, S, M> = {
    ...
    startFlow: <FlowName extends keyof F>(flowName: Extract<FlowName, string>, request: RequestSource, input?: ReallyAny, // FromSchema<F[FlowName]['input']>
    options?: {
    ...
    paginateStep: (request: RequestSource, reference?: ModelReference<M>, options?: {
        crawlerOptions?: RequestCrawlerOptions;
    }) => void;
    nextStep: (stepName: Extract<keyof S, string>, request: RequestSource, reference?: ModelReference<M>, options?: {
        crawlerOptions?: RequestCrawlerOptions;
    }) => void;
    nextDefaultStep: (request?: RequestSource, reference?: ModelReference<M>, options?: {
        crawlerOptions?: RequestCrawlerOptions;
    }) => void;
...
export declare type StepApiModelByFlowAPI<M extends Record<string, ModelDefinition>, AvailableModelNames = keyof M> = {
    get: <ModelName extends AvailableModelNames>(modelName: Extract<ModelName, string>, ref?: ModelReference<M>) => ModelName extends keyof M ? TrailDataModelItem : never;
    set: <ModelName extends AvailableModelNames>(modelName: Extract<ModelName, string>, value: ModelName extends keyof M ? DeepOmitModels<M[ModelName]['schema']> : never, ref?: ModelReference<M>) => ModelReference<M>;
    setPartial: <ModelName extends AvailableModelNames>(modelName: Extract<ModelName, string>, value?: ModelName extends keyof M ? DeepPartial<DeepOmitModels<M[ModelName]['schema']>> : never, ref?: ModelReference<M>) => ModelReference<M>;
    upsert: <ModelName extends AvailableModelNames, ModelSchema = ModelName extends keyof M ? DeepOmitModels<M[ModelName]['schema']> : never>(modelName: Extract<ModelName, string>, value: ModelName extends keyof M ? (ModelSchema | ((previous: DeepPartial<ModelSchema>) => ModelSchema)) : never, ref?: ModelReference<M>) => ModelReference<M>;
    upsertPartial: <ModelName extends AvailableModelNames, ModelSchema = ModelName extends keyof M ? DeepOmitModels<M[ModelName]['schema']> : never>(modelName: Extract<ModelName, string>, value?: ModelName extends keyof M ? (DeepPartial<ModelSchema> | ((previous: DeepPartial<ModelSchema>) => DeepPartial<ModelSchema>)) : never, ref?: ModelReference<M>) => ModelReference<M>;
    update: <ModelName extends AvailableModelNames, ModelSchema = ModelName extends keyof M ? DeepOmitModels<M[ModelName]['schema']> : never>(modelName: Extract<ModelName, string>, value: ModelName extends keyof M ? (ModelSchema | ((previous: DeepPartial<ModelSchema>) => ModelSchema)) : never, ref?: ModelReference<M>) => ModelReference<M>;
    updatePartial: <ModelName extends AvailableModelNames, ModelSchema = ModelName extends keyof M ? DeepOmitModels<M[ModelName]['schema']> : never>(modelName: Extract<ModelName, string>, value: ModelName extends keyof M ? (DeepPartial<ModelSchema> | ((previous: DeepPartial<ModelSchema>) => DeepPartial<ModelSchema>)) : never, ref?: ModelReference<M>) => ModelReference<M>;
...
export declare type StepApiHelpersInstance = {
    handler: (context: RequestContext) => StepApiHelpersAPI;
};
export declare type StepApiHelpersAPI = {
...
export declare type StoreCollectionInstance<DataStoreNames extends string[] = DefaultDataStoreNames, FileStoreNames extends string[] = DefaultFileStoreNames> = GenerateObject<FileStoreNames & DefaultFileStoreNames, FileStoreInstance> & GenerateObject<DataStoreNames & DefaultDataStoreNames, DataStoreInstance>;
...
export declare type DefaultFileStoreNames = ['cachedRequests', 'files', 'responseBodies', 'browserTraces'];
export declare type StoreCollectionOptions = {
...
export declare type QueueCollectionInstance<Names extends string[] = []> = GenerateObject<Names | DefaultQueueNames, StepInstance>;
export declare type QueueCollectionOptions<Names> = {
...
export declare type DatasetCollectionInstance<Names extends string[] = []> = GenerateObject<Names | DefaultDatasetNames, DatasetInstance>;
export declare type DatasetCollectionOptions<Names extends string[] = []> = {
    names?: Names;
};
...
export declare type RequestCrawlerOptions = {
...
export declare type EventsOptions = {
    name?: string;
    batchSize?: number;
...
export declare type KVStoreAdapterInstance<T = ReallyAny> = KVStoreAdapterOptions<T> & BaseInstance;
export declare type KVStoreAdapterOptions<T = ReallyAny> = {
    resource?: ReallyAny;
...
export declare type KVStoreAdapterListResult = {
    keys: {
        key: string;
        size?: number;
    }[];
