import { DataStoreInstance, DataStoreOptions } from '@usefelps/types';
...
export declare const get: <T = any>(dataStore: DataStoreInstance, path?: string) => T;
...
export declare const entries: <T = any>(dataStore: DataStoreInstance, path?: string) => [string, T][];
export declare const values: <T = any>(dataStore: DataStoreInstance, path?: string) => T[];
export declare const keys: <T = any>(dataStore: DataStoreInstance, path?: string) => string[];
...
declare const _default: {
    ...
    get: <T = any>(dataStore: DataStoreInstance, path?: string) => T;
    ...
    entries: <T_2 = any>(dataStore: DataStoreInstance, path?: string) => [string, T_2][];
    values: <T_3 = any>(dataStore: DataStoreInstance, path?: string) => T_3[];
    keys: <T_4 = any>(dataStore: DataStoreInstance, path?: string) => string[];
